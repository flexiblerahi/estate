...
<div class="row">
    <div class="col">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="trx_num" id="trx_num" @if($bank_info->bankname->id == 1) disabled @endif value="@isset($transaction) {{ $transaction->trx_no }} @endisset" placeholder="Transaction Serial Number">
        </div>
    </div>
    <div class="col">
        @php
        ...
        <div class="form-group">
          ...
          <select class="form-control" @if($bank_info->bankname->id == 1) disabled @endif name="trx_by" id="trx_by">
    ...
    <div class="card">
        ...
        <div class="card-body pb-0">
            <div class="row">
                ...
                <div class="col">
                    <p class="investor_info"><span class="font-weight-bold">Amount : </span> <span id="bank_balance">{{tk($bank_info->amount)}}</span></p>
                    <div class="form-group">
