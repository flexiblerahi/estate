                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <input type="text" class="form-control" id="user_details_phone" data-user="agent" list="user_details_list" placeholder="Search by agent or master agent phone number or Account id">
